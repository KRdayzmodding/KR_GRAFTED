...
Мод-лоадер, позволяющий стабильно и унифицированно загружать в игру серверные моды на C++.

**Blazingly-fast**, без ограничений и недостатков языка скриптов. 

Вы наделены полным контролем, ограниченным лишь серверной частью и вашей фантазией.
...
Со стороны скрипта `IsValidNick` неотличим от ванильного натива. Со стороны C++ это обычная функция — движок
зовёт её напрямую, по адресу, без прослойки.
